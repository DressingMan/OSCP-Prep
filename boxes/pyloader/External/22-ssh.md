## NMAP 
```bash
# Nmap 7.94SVN scan initiated Mon Jul 15 22:06:35 2024 as: nmap -vv --reason -Pn -T4 -sV -p 22 --script=banner,ssh2-enum-algos,ssh-hostkey,ssh-auth-methods TARGET
