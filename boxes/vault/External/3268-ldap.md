...
```
# Nmap 7.94SVN scan initiated Sat Jul 27 19:19:39 2024 as: nmap -vv --reason -Pn -T4 -sV -p 3268 "--script=banner,(ldap* or ssl*) and not (brute or broadcast or dos or external or fuzzer)" -oN /home/kali/... -oX /home/kali/... TARGET
Nmap scan report for TARGET
Host is up, received user-set (0.065s latency).
Scanned at 2024-07-27 19:19:40 EDT for 17s

PORT     STATE SERVICE REASON          VERSION
3268/tcp open  ldap    syn-ack ttl 125 Microsoft Windows Active Directory LDAP (Domain: vault.offsec, Site: Default-First-Site-Name)
| ldap-rootdse: 
| LDAP Results
|   <ROOT>
