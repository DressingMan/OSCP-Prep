## NMAP 
```
# Nmap 7.94SVN scan initiated Sat Jun 29 20:52:26 2024 as: nmap -vv --reason -Pn -T4 -sV -p 22 --script=banner,ssh2-enum-algos,ssh-hostkey,ssh-auth-methods TARGET
