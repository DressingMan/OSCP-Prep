...
```
# Nmap 7.94SVN scan initiated Mon Jul  1 17:33:43 2024 as: nmap -vv --reason -Pn -T4 -sV -p 9999 "--script=banner,(http* or ssl*) and not (brute or broadcast or dos or external or http-slowloris* or fuzzer)" -oN /home/kali/... -oX /home/kali/... TARGET
Nmap scan report for TARGET
Host is up, received user-set (0.076s latency).
Scanned at 2024-07-01 17:33:45 EDT for 8s

PORT     STATE SERVICE    REASON         VERSION
9999/tcp open  tcpwrapped syn-ack ttl 61

Read data files from: /usr/bin/../share/nmap
Service detection performed. Please report any incorrect results at https://nmap.org/submit/ .
# Nmap done at Mon Jul  1 17:33:53 2024 -- 1 IP address (1 host up) scanned in 9.95 seconds
...
```
https://TARGET:9999/blog                 (Status: 200) [Size: 7605]
https://TARGET:9999/favicon.ico          (Status: 200) [Size: 600]
https://TARGET:9999/fs                   (Status: 401) [Size: 21]
https://TARGET:9999/photos.html          (Status: 200) [Size: 6761]
https://TARGET:9999/private              (Status: 401) [Size: 21]
https://TARGET:9999/red.txt              (Status: 200) [Size: 42]
https://TARGET:9999/flower.txt           (Status: 200) [Size: 95]
https://TARGET:9999/passion.txt          (Status: 200) [Size: 76]
https://TARGET:9999/rtl                  (Status: 200) [Size: 2237]
https://TARGET:9999/sky.txt              (Status: 200) [Size: 112]
...
+ Target Port:        9999
---------------------------------------------------------------------------
+ SSL Info:        Subject:  /C=US/ST=California/CN=FuguHub
                   Ciphers:  ECDHE-RSA-CHACHA20-POLY1305
                   Issuer:   /C=US/O=Real Time Logic LLC/OU=SharkSSL/CN=Real Time Logic Root CA/emailAddress=ginfo@realtimelogic.com
...
+ Hostname 'TARGET' does not match certificate's names: FuguHub. See: https://cwe.mitre.org/data/definitions/297.html
...
+ OPTIONS: WebDAV enabled (LOCK MKCOL PROPFIND COPY PROPPATCH UNLOCK listed as allowed).
+ /rtl/protected/admin/help/config.php: Default account found for '' at (ID '', PW 'Cisco'). Cisco device. See: CWE-16
+ /rtl/protected/admin/help/config.php: PHP Config file may contain database IDs and passwords.
+ /private/: Uncommon header 'banned' found, with contents: BANNED.
...
![Pasted image 20240701181939.png](Evidence/Pasted%20image%2020240701181939.png)
