...
```bash
# Nmap 7.94SVN scan initiated Wed Jul 24 19:14:31 2024 as: nmap -vv --reason -Pn -T4 -sV -sC --version-all -A --osscan-guess TARGET
...
53/tcp open domain?
88/tcp open kerberos-sec Microsoft Windows Kerberos (server time: 2024-07-24 23:14:46Z)
...
#### Full Scan
```bash
# Nmap 7.94SVN scan initiated Wed Jul 24 19:14:31 2024 as: nmap -vv --reason -Pn -T4 -sV -sC --version-all -A --osscan-guess -p- TARGET
Nmap scan report for TARGET
...
88/tcp open kerberos-sec Microsoft Windows Kerberos (server time: 2024-07-24 23:16:25Z)
135/tcp open msrpc Microsoft Windows RPC
139/tcp open netbios-ssn Microsoft Windows netbios-ssn
389/tcp open ldap Microsoft Windows Active Directory LDAP (Domain: resourced.local0., Site: Defau...
445/tcp open microsoft-ds?
