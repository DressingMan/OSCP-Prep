## NMAP 
```
# Nmap 7.94SVN scan initiated Wed Jun 19 22:52:53 2024 as: nmap -vv --reason -Pn -T4 -sV -p 22 --script=banner,ssh2-enum-algos,ssh-hostkey,ssh-auth-methods TARGET
