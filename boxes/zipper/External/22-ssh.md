## NMAP 
```bash
# Nmap 7.94SVN scan initiated Tue Jul 16 15:01:21 2024 as: nmap -vv --reason -Pn -T4 -sV -p 22 --script=banner,ssh2-enum-algos,ssh-hostkey,ssh-auth-methods TARGET
