...
creating a symbolic link to connect  /root/secret to enox.zip->
```
ln -s /root/secret enox.zip
```

Next we create a file named @enox.zip which will tell 7z that enox.zip is a list file:
```
touch @enox.zip
```
...
![Pasted image 20240716163624.png](Evidence/Pasted%20image%2020240716163624.png)
