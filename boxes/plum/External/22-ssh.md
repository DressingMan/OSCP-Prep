## NMAP 
```
# Nmap 7.94SVN scan initiated Fri Jun 21 08:57:42 2024 as: nmap -vv --reason -Pn -T4 -sV -p 22 --script=banner,ssh2-enum-algos,ssh-hostkey,ssh-auth-methods -oN /home/kali/... -oX /home/kali/... TARGET
Nmap scan report for TARGET
Host is up, received user-set (0.081s latency).
Scanned at 2024-06-21 08:57:43 EDT for 2s
...
# Nmap done at Fri Jun 21 08:57:45 2024 -- 1 IP address (1 host up) scanned in 2.93 seconds
...
```
# general
(gen) banner: SSH-2.0-OpenSSH_8.4p1 Debian-5+deb11u1
...
# fingerprints
(fin) ssh-ed25519: SHA256:dFgkgTXNmYqIKoPgky6aPnKabkiw7Jf4aZnS4Gwv82Y
(fin) ssh-rsa: SHA256:/9qhgm7xR8GpTC766/QNbI8wjp0NfDx0SkxNqymK0h4
